...
export class PersonTracker {
    ...
    async processFrame(videoElement, canvas = null) {
        ...
        if (canvas) {
            this.drawDetections(canvas, videoElement, detections, trackingResults.tracks);
        }
    ...
    drawDetections(canvas, videoElement, detections, tracks) {
        ...
        // Calculate scale factors between video natural size and canvas display size
        ...
        detections.forEach(detection => {
            ...
            ctx.fillText(
                ...
                scaledX, scaledY > 20 ? scaledY - 5 : scaledY + scaledHeight + 15
            );
        });
        ...
        Object.values(tracks).forEach(track => {
            ...
            if (track.history.length > 1) {
                ...
                ctx.font = '14px Arial';
                ctx.fillText(`ID: ${track.id}`, latestPoint[0] * scaleX, latestPoint[1] * scaleY);
            }
        });
    }
